...
// alphaSort(['b', 'a', 'c'])
// > ['a', 'b', 'c']
function alphaSort(stringArray) {
...
// > ['Apple', 'Cherry', 'Banana']
function strLengthSort(stringArray) {
...
// ])
// > [[2], [4, 5], [9, 1, 9]]
function sumSort(arrayArray) {
  return arrayArray.sort( (a, b) =>
    a.reduce((accum, value) =>
      accum + value) -
    b.reduce((accum, value) =>
      accum + value))
}
